...
for multmask in MultiplicityMasks:
    ...
    print('E4 AD',Muon_Energy_L1[ADmask])
    if np.sum(ADmask)>0:
        ...
        filename = '/home/zrechav/scripts/air_shower_reader/quadruple_histogram_making/histograms/' + flavour + '_Quad_Zen_' + str(np.around(coszen,2)) + '_Depth_' + str(np.around(depth,2)) + '.npy'
