...
print(infile)
#infile.insert(0,options.GCD)
#print(infile.insert(0,options.GCD))
#infile = infile[1]
#print(infile)
#infile = infile.insert(0,options.GCD)
#infile = options.INPUT
...
def get_deposit_energy(frame):
    #print('IM IN GET DEPOSIT ENERGY')
    energy_max=0
    e_max_muon=None
    losses_max=0
    ...
    if 'I3MCTree_copy' in frame:
        ...
        for muon in mctree:#get muon energies
            if (boundary_check(muon,gcdFile)): continue
