...
def get_Grid_job(infile,filenum,outfile,gcd, nugen,muongun,corsika,burn):
    if nugen==1:
        ...
        lines =[
            'JOB ' + job_name + ' /home/zrechav/scripts/air_shower_reader/AirShowerReader_NPX.sub',
...
if nugen ==1:
    ...
    #input_path='/data/ana/PointSource/DNNCascade/i3_processing/version-1.0/DNNCascadeL5/version-001-p01/NuGen/' + dataset + '/' + subdir + '/'
    #input_path= '/data/user/zrechav/vertex_split/' + dataset + '/' + subdir + '/' + tag + '/'
    #input_path = '/data/user/zrechav/dnn_cascade_selection/DNNCascades_MuonBundle/version-1.0/DNNCascadeL5/version-001-p01/NuGen/' + dataset + '/' + short_subdir + '/'
    #output_path='/data/user/zrechav/vertex_flag/' + dataset + '/'
    input_path = '/data/user/zrechav/propagated_corsika/20904/' + subdir + '/'
    #output_path = '/data/user/zrechav/airshowered_corsika/20904/0000000-0000999/'
...
outfile_name='/home/zrechav/scripts/air_shower_reader/' + dataset + '_' + subdir + '.dag'
