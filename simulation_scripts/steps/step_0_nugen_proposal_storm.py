...
def main(cfg, run_number, scratch):
    ...
    random_service, random_service_prop, rnd_bias, rnd_storm = random_services
    ...
    if 'muon_propagation_config' in cfg:
        tray.AddSegment(segments.PropagateMuons,
                        ...
                        PROPOSAL_config_file=temp_proposal_file,
                        **cfg['muon_propagation_config'])
    else:
        raise NotImplementedError(
            'PROPOSALStorm currently only supported outside of CLSIm')
