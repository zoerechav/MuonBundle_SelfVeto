...
input_path = '/data/user/zrechav/airshowered_corsika/' + dataset + '/' + subdir + '/'
output_path = '/data/user/zrechav/compiled_hdf5s/airshowered_corsika/' + dataset + '/' + dataset + '_' + subdir + '_unweighted.hdf5'
...
outfile_name='/home/zrechav/SelfVeto_Correlation_Tables/scripts/compiling/dags/' + dataset + '_' + subdir + '_make_sampled_corsika_hdf.dag'
