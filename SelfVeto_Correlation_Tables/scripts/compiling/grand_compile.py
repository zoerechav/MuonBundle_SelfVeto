...
table_keys = [
    "CorsikaWeightMap", "I3EventHeader", "MuonMultiplicity",
    "Muon_Energy_L1", "Muon_Energy_L2", "Muon_Energy_L3",
    "Muon_Energy_L4", "Muon_L1", "Muon_L1_Depth",
    "Muon_L1_Neutrino_separation", "Muon_L1_Shower_separation",
    "Muon_L1_rho", "Muon_L1_rho_inter", "Muon_L1_x_inter",
    "Muon_L1_y_inter", "Muon_L1_z_inter", "Muon_L2",
    "Muon_L2_Depth", "Muon_L2_Neutrino_separation", 
    "Muon_L2_Shower_separation", "Muon_L2_rho", 
    "Muon_L2_rho_inter", "Muon_L2_x_inter", "Muon_L2_y_inter",
    "Muon_L2_z_inter", "Muon_L3", "Muon_L3_Depth",
    "Muon_L3_Neutrino_separation", "Muon_L3_Shower_separation",
    "Muon_L3_rho", "Muon_L3_rho_inter", "Muon_L3_x_inter",
    "Muon_L3_y_inter", "Muon_L3_z_inter", "Muon_L4",
    "Muon_L4_Depth", "Muon_L4_Neutrino_separation",
    "Muon_L4_Shower_separation", "Muon_L4_rho",
    "Muon_L4_rho_inter", "Muon_L4_x_inter", "Muon_L4_y_inter",
    "Muon_L4_z_inter", 
    "NeutrinoParent", "PolyplopiaPrimary", "PrimaryMass",
    "ShowerNeutrino", "Total_Muon_Energy",
    "num_neutrinos", "rho_inter", "rho_neutrino",
    "shower_neutrino_depth", "shower_neutrino_energy",
    "shower_neutrino_type", "shower_neutrino_zenith",
    "total_neutrino_energy", "x_inter",
    "y_inter", "z_inter"
]
